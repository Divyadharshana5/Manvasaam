...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SidebarProvider>
      <Sidebar className="!hidden !w-0 !min-w-0">
        <SidebarHeader>
          <div
            className={cn(
      ...
      <SidebarInset className="overflow-x-hidden w-full !ml-0 !left-0 flex-1">
        ...
        <main className="flex-1 overflow-auto bg-background">
          <div className="w-full max-w-[1200px] mx-auto px-4 md:px-6">{children}</div>
        </main>
      </SidebarInset>
    </SidebarProvider>
  );
