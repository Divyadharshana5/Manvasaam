      ...
      <div className="max-w-6xl mx-auto">
            ...
            <Card className="h-80 bg-white/80 backdrop-blur-sm border-emerald-200 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent className="space-y-4">
                <div className="text-sm text-gray-600 space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      className="w-3 h-3 bg-green-500 rounded-full farmer-soil-ripple"
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      className="w-3 h-3 bg-brown-600 rounded-full farmer-soil-ripple"
            ...
            <Card className="h-80 bg-white/80 backdrop-blur-sm border-emerald-200 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent className="space-y-4">
                <div className="text-sm text-gray-600 space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      className="w-3 h-3 bg-red-500 rounded-full restaurant-flame-flicker"
            ...
            <Card className="h-80 bg-white/80 backdrop-blur-sm border-emerald-200 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent className="space-y-4">
                <div className="text-sm text-gray-600 space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      className="w-3 h-3 bg-indigo-500 rounded-full hub-pulse-glow"
                      style={{ animationDelay: "1.5s" }}
                    ></div>
            ...
            <Card className="h-80 bg-white/80 backdrop-blur-sm border-emerald-200 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent className="space-y-4">
                <div className="text-sm text-gray-600 space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      className="w-3 h-3 bg-red-400 rounded-full customer-heart-beat"
                      style={{ animationDelay: "2s" }}
                    ></div>
        ...
        >
          ...
          <div className="relative h-32 bg-gradient-to-r from-emerald-100 to-green-100 rounded-lg overflow-hidden">
            ...
            <div
              className="absolute top-16 right-1/4 w-6 h-6 bg-green-300/50 rounded-full floating-bubble"
              style={{ animationDelay: "1s" }}
            ></div>
            <div
              className="absolute bottom-8 left-1/3 w-10 h-10 bg-lime-300/50 rounded-full floating-bubble"
              style={{ animationDelay: "2s" }}
            ></div>
            <div
              className="absolute bottom-16 right-1/3 w-7 h-7 bg-emerald-400/50 rounded-full floating-bubble"
