      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            +20.1% {t.dashboard?.fromLastMonth || "from last month"}
          </p>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            +180.1% {t.dashboard?.fromLastMonth || "from last month"}
          </p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">
            {t.dashboard?.productsSold || "Products Sold"}
          </CardTitle>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            +19% {t.dashboard?.fromLastMonth || "from last month"}
          </p>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent>
          ...
          <Link href="/dashboard/profile">
            ...
            >
              {t.dashboard?.viewProfile || "View your profile"}
            </Button>
          </Link>
        </CardContent>
      </Card>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Profit earned via the application
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              A list of the latest orders for your products.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Your total spending on the app
            </p>
          </CardContent>
        </Card>
      </div>
