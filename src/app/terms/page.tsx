        ...
        >
          ...
          <motion.div variants={fadeInUp} className="text-center space-y-4">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              These terms govern your use of the Manvaasam agricultural marketplace platform. 
          ...
          <motion.div variants={fadeInUp}>
            <Alert className="border-amber-200 bg-amber-50">
              ...
              <AlertDescription className="text-amber-800">
                <strong>Important:</strong> By using Manvaasam, you agree to these terms. 
              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="text-center p-4">
                    ...
                    <p className="text-sm text-gray-600">Use platform responsibly and legally</p>
                  </div>
                  <div className="text-center p-4">
                    <Shield className="h-8 w-8 text-primary mx-auto mb-2" />
                    <h3 className="font-semibold">Account Security</h3>
                    <p className="text-sm text-gray-600">Keep your login credentials safe</p>
                  </div>
                  <div className="text-center p-4">
                    <Scale className="h-8 w-8 text-primary mx-auto mb-2" />
                    <h3 className="font-semibold">Legal Compliance</h3>
                    <p className="text-sm text-gray-600">Follow all applicable laws</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <motion.div variants={fadeInUp}>
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Transaction Terms</h4>
                  <ul className="list-disc list-inside space-y-1 text-gray-600">
                    <li>All transactions are between buyers and sellers directly</li>
                    <li>Manvaasam facilitates connections but is not party to transactions</li>
                    <li>Prices, quality, and delivery terms are set by sellers</li>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">
                      The Manvaasam platform, including its design, features, and content, is protected by intellectual property laws.
                    </p>
                    <ul className="list-disc list-inside space-y-1 text-gray-600">
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-gray-600">
                    Manvaasam provides the platform "as is" and makes no warranties about:
                  </p>
                  <ul className="list-disc list-inside space-y-1 text-gray-600">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg mt-4">
                    <p className="text-sm text-gray-600">
                      <strong>Important:</strong> Our liability is limited to the maximum extent permitted by law. 
            ...
            <Card className="border-primary/20 bg-primary/5">
              ...
              <CardContent>
                ...
                <div className="space-y-2 text-sm">
                  <p><strong>Email:</strong> legal@manvaasam.com</p>
