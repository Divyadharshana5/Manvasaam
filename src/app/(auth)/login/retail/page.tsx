...
import { Loader2, Eye, EyeOff, Building, Fingerprint, CheckCircle, AlertCircle, Mic } from "lucide-react";
  ...
  function handleVoiceCommand(command: string) {
    ...
    if (lowerCommand.includes("what is manvaasam")) {
      ...
      toast({
        ...
        description: "Please complete login first to access your retail dashboard.",
        duration: 3000,
      });
      ...
      toast({
        ...
        description: "Please fill out the form to create your retail account.",
        duration: 2000,
      });
    ...
    <div className="animate-in fade-in duration-1000 relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        <div className="absolute inset-0 -z-5">
          <div
            className="absolute top-28 left-14 w-32 h-32 bg-purple-200/25 dark:bg-purple-800/25 rounded-full blur-xl floating-bubble"
            style={{ animationDelay: "0.3s" }}
          ></div>
          <div
            className="absolute top-20 right-18 w-28 h-28 bg-pink-200/30 dark:bg-pink-800/30 rounded-full blur-xl floating-bubble"
            style={{ animationDelay: "0.9s" }}
          ></div>
          <div
            className="absolute bottom-32 left-18 w-36 h-36 bg-rose-200/25 dark:bg-rose-800/25 rounded-full floating-bubble"
            style={{ animationDelay: "1.5s" }}
          ></div>
          <div
            className="absolute bottom-24 right-14 w-30 h-30 bg-purple-300/30 dark:bg-purple-700/30 rounded-full floating-bubble"
        ...
        <div className="absolute inset-0 flex items-center justify-center -z-5">
          <div className="text-center max-w-2xl mx-auto px-4">
            <motion.h2
              ...
              className="text-4xl md:text-6xl font-bold text-purple-700 dark:text-purple-300 mb-4"
            >
              Fresh Products, Direct Sales
            </motion.h2>
          </div>
        </div>

        <Card className="w-full max-w-md bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border border-purple-200 dark:border-purple-700 card-entrance relative z-10 hover:shadow-2xl hover:scale-[1.03] transition-all duration-500 hover:border-purple-300 dark:hover:border-purple-600 hover:bg-white dark:hover:bg-gray-900 group enhanced-hover smooth-transition gpu-accelerated">
          <CardHeader className="text-center px-4 sm:px-6 py-4 sm:py-6 relative">
            {/* Animated icon */}
            <div className="flex items-center justify-center w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900 dark:to-pink-900 rounded-full border-2 border-purple-200 dark:border-purple-700 icon-bounce-in hover:scale-110 transition-all duration-300 group-hover:shadow-lg hover:rotate-6 auth-animation-container stagger-1">
              <motion.div
            ...
            <CardTitle className="text-xl sm:text-2xl font-bold text-purple-700 dark:text-purple-300 animate-in slide-in-from-top-2 duration-800 delay-600 hover:text-purple-600 dark:hover:text-purple-200 transition-colors duration-300 text-reveal stagger-2">
              Retail Portal
            </CardTitle>
            <CardDescription className="text-base sm:text-lg text-purple-600 dark:text-purple-400 animate-in fade-in duration-800 delay-800 hover:text-purple-500 dark:hover:text-purple-300 transition-colors duration-300 text-reveal stagger-3">
          ...
          <CardContent className="relative z-20">
            ...
            >
              <TabsList className="grid w-full grid-cols-2 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900 dark:to-pink-900 p-1 rounded-lg relative z-40 pointer-events-auto animate-in slide-in-from-bottom-2 duration-600 delay-1000 shadow-inner">
                <TabsTrigger
                  value="login"
                  className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-200 data-[state=active]:to-pink-200 dark:data-[state=active]:from-purple-700 dark:data-[state=active]:to-pink-700 data-[state=active]:shadow-md transition-all duration-400 cursor-pointer hover:scale-105 hover:bg-purple-150 dark:hover:bg-purple-800 transform-gpu animate-in slide-in-from-left-2 duration-500 delay-1200"
                >
                  {t.auth.login}
                </TabsTrigger>
                <TabsTrigger
                  value="register"
                  className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-200 data-[state=active]:to-pink-200 dark:data-[state=active]:from-purple-700 dark:data-[state=active]:to-pink-700 data-[state=active]:shadow-md transition-all duration-400 cursor-pointer hover:scale-105 hover:bg-purple-150 dark:hover:bg-purple-800 transform-gpu animate-in slide-in-from-right-2 duration-500 delay-1200"
                >
                  {t.auth.register}
                </TabsTrigger>
              </TabsList>
                  ...
                  >
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              type="email"
                              placeholder="retail@gmail.com"
                              className="border-purple-200 dark:border-purple-700 focus:border-purple-400 dark:focus:border-purple-500 focus:ring-purple-200 dark:focus:ring-purple-800 bg-purple-50/50 dark:bg-purple-950/50 placeholder:text-purple-500 dark:placeholder:text-purple-400"
                              {...field}
                            />
                          </FormControl>
                        ...
                        <FormItem>
                          <div className="flex justify-between items-center">
                            ...
                            <Button
                              ...
                              size="sm"
                              type="button"
                              className="p-0 h-auto text-xs text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-200"
                          ...
                          <FormControl>
                            <div className="relative">
                              <Input
                                ...
                                className="border-purple-200 dark:border-purple-700 focus:border-purple-400 dark:focus:border-purple-500 focus:ring-purple-200 dark:focus:ring-purple-800 bg-purple-50/50 dark:bg-purple-950/50"
                                {...field}
                              />
                              <Button
                                type="button"
                    ...
                    {passkeyStatus.supported && (
                      <div className="mt-4 pt-4 border-t border-purple-200 dark:border-purple-700">
                        ...
                        <div className="bg-purple-50 dark:bg-purple-950 p-2 rounded mb-3">
                        ...
                        <Button
                          type="button"
                          variant="outline"
                          className="w-full border-purple-300 dark:border-purple-600 text-purple-700 dark:text-purple-300 hover:bg-purple-50 dark:hover:bg-purple-900"
              ...
              >
                <Form {...registerForm}>
                  ...
                  >
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white transition-all duration-400 hover:scale-[1.05] hover:shadow-xl active:scale-[0.98] transform-gpu animate-in slide-in-from-bottom-2 duration-600 delay-700 hover:rotate-1"
                      disabled={loading}
                    >
                      {loading && (
                        <Loader2 className="mr-2 h-4 w-4 animate-spin" />
