    ...
    <div className="space-y-3 p-4 bg-muted/50 rounded-lg border">
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-sm">
          <span>Lighting:</span>
          <span className={getQualityColor(analysis.lighting)}>{analysis.lighting}</span>
        </div>
        <div className="flex justify-between text-sm">
          <span>Clarity:</span>
          <span className={getQualityColor(analysis.clarity)}>{analysis.clarity}</span>
        </div>
        <div className="flex justify-between text-sm">
                                            ...
                                            {!facePhoto ? (
                                                <div className="space-y-2">
                                                    <p className="text-sm text-muted-foreground text-center">
                                                        Advanced face recognition with real-time quality analysis
                                                    </p>
  ...
  async function onRegister(values: z.infer<typeof registerSchema>) {
    ...
    try {
      ...
      toast({
        ...
        description: "Your account has been created with enhanced security features. Please log in.",
      });
      setActiveTab("login");
  ...
  return (
    <Card className="w-full max-w-md bg-card/80 backdrop-blur-lg border-2 border-primary/20 shadow-lg">
      <CardHeader className="text-center">
        ...
        <CardDescription>Enhanced security with AI-powered face recognition</CardDescription>
      </CardHeader>
      <CardContent>
