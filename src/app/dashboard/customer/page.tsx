    ...
    <div className="flex flex-1 flex-col gap-6 p-4 md:gap-8 md:p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Search and order fresh products directly from farmers
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
                      ...
                      <Button size="sm" variant="outline" asChild>
                        <Link
                          href={{
                            ...
                            query: { mode: "call", with: order.farmer },
                          }}
                        >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Easy payment options and farmer communication
            </CardDescription>
          </CardHeader>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Real-time delivery status and location
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="border rounded-lg p-3">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  Fresh Milk - 1L from Happy Cow Dairy
                </p>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-2 border rounded">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Your order #ORD003 has been confirmed
                  </p>
              ...
              <div className="flex items-start gap-3 p-2 border rounded">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Fresh strawberries now available from Mountain Fresh
                  </p>
