    ...
    timeline: [
      {
        ...
        status: "Order Placed",
        completed: true,
        description: "Order confirmed by Green Valley Farm",
      },
      {
        time: "08:30 AM",
        status: "Pickup Scheduled",
        completed: true,
        description: "Vehicle assigned and route planned",
      },
      {
        time: "09:15 AM",
        status: "In Transit",
        completed: true,
        description: "Items loaded and delivery started",
        current: true,
      },
      {
        time: "11:30 AM",
      ...
      },
      {
        ...
        status: "Delivered",
        completed: false,
        description: "Delivery completion expected",
      },
    ],
    eta: "11:30 AM",
    distance: {
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Fresh produce from {delivery.from.name}
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {delivery.driver.experience} experience
                    </p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Capacity: {delivery.vehicle.capacity}
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm font-medium">
                        {delivery.vehicle.temperature}°C
                      </span>
                    </div>
