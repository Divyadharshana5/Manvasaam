...
export default function DeliveryTracking() {
  ...
  const trackingData = {
    ...
    alerts: [
      {
        type: "info",
        message: "Vehicle is on optimal route",
        time: "2 min ago",
      },
      {
        type: "success",
      ...
      <div className="flex flex-col gap-4 p-4 md:gap-6 md:p-6 max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Badge
              variant={isLiveTracking ? "default" : "secondary"}
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent>
                ...
                <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Updated:{" "}
                    {trackingData.currentLocation.timestamp.toLocaleTimeString()}
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Track delivery progress along the route
                </CardDescription>
              </CardHeader>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {trackingData.route.progress}%
                    </span>
                  </div>
                  <Progress
                    value={trackingData.route.progress}
                    className="h-3"
                  />
                ...
                <div className="space-y-3">
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm font-medium">
                        {trackingData.vehicle.speed} km/h
                      </span>
                    </div>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm font-medium">
                        {trackingData.vehicle.fuel}%
                      </span>
                    </div>
                    <Progress
                      value={trackingData.vehicle.fuel}
                      className="h-2"
                    />
                  </div>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm font-medium">
                        {trackingData.vehicle.temperature}°C
                      </span>
                    </div>
                    <div className="text-xs text-green-600">
                      Optimal for fresh produce
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2">
                  <Button size="sm" className="flex-1" asChild>
                    <Link
                      href={`/dashboard/transport/deliveries/contact?driver=${trackingData.driver.name}&phone=${trackingData.driver.phone}`}
                    >
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium">
                    {trackingData.route.totalDistance}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">Remaining</span>
                  <span className="text-sm font-medium text-blue-600">
                    {trackingData.route.remainingDistance}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">ETA</span>
                  <span className="text-sm font-medium text-green-600">
                    {trackingData.route.estimatedArrival}
                  </span>
                </div>

                <Button size="sm" className="w-full mt-4" asChild>
                  <Link
                    href={`/dashboard/transport/deliveries/details?id=${trackingData.id}`}
                  >
