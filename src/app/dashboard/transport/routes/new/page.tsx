...
export default function NewRoutePage() {
  ...
  const routeTypes = [
    {
      value: "urban",
      label: "Urban Route",
      description: "City and suburban areas",
    },
    {
      value: "highway",
      label: "Highway Route",
    ...
    },
    {
      value: "rural",
      label: "Rural Route",
      description: "Rural and countryside areas",
    },
    {
      value: "mixed",
      label: "Mixed Route",
      description: "Combination of urban and highway",
    },
  ];
  ...
  const vehicleTypes = [
    {
      value: "small",
      label: "Small Vehicle",
      description: "Up to 1 ton capacity",
    },
    {
      value: "medium",
      label: "Medium Vehicle",
      description: "1-3 ton capacity",
    },
  ...
  const handleCreateRoute = async () => {
    ...
    try {
      ...
      alert(
        `Route "${routeData.name}" created successfully! Redirecting to route details...`
      );
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Basic details about your new route
                </CardDescription>
              </CardHeader>
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: string) =>
                        setRouteData({ ...routeData, routeType: value })
                      }
                    >
                      <SelectTrigger>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: string) =>
                        setRouteData({ ...routeData, priority: value })
                      }
                    >
                      <SelectTrigger>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Define start, end, and waypoints for your route
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Button
                      type="button"
                      className="border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground h-auto py-2 rounded-md px-3 justify-start whitespace-normal"
                      onClick={addWaypoint}
                    >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure vehicle requirements and optimization preferences
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: string) =>
                        setRouteData({ ...routeData, vehicleType: value })
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setRouteData({ ...routeData, maxStops: e.target.value })
                      }
                    />
                  </div>
                </div>
                    ...
                    {optimizationOptions.map((option) => (
                      <div
                        ...
                        className={`p-3 border rounded-lg cursor-pointer transition-colors ${
                          routeData.optimizeFor === option.value
          ...
          <div className="space-y-6">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {routeData.estimatedDistance} km
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Time:</span>
                      <span className="font-medium">
                        {routeData.estimatedTime} hrs
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Waypoints:</span>
                      <span className="font-medium">
                        {waypoints.filter((wp) => wp.trim()).length}
                      </span>
                    </div>
                  </div>
                )}
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    ₹
                    {routeData.estimatedDistance
                      ? Math.round(
                          parseFloat(routeData.estimatedDistance) * 8.5
                        )
                      : 0}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    ...
                    {routeData.estimatedTime
                      ? Math.round(parseFloat(routeData.estimatedTime) * 200)
                      : 0}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    ₹
                    {routeData.estimatedDistance
                      ? Math.round(parseFloat(routeData.estimatedDistance) * 5)
                      : 0}
                  </span>
                </div>
                <div className="border-t pt-2 flex justify-between font-semibold">
                  ...
                  <span>
                    ...
                    {routeData.estimatedDistance && routeData.estimatedTime
                      ? Math.round(
                          parseFloat(routeData.estimatedDistance) * 8.5 +
                            parseFloat(routeData.estimatedTime) * 200 +
                            parseFloat(routeData.estimatedDistance) * 5
                        )
                      : 0}
                  </span>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <Button
                  className="w-full border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground justify-start whitespace-normal h-auto py-2"
                ...
                <Button className="w-full border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground justify-start whitespace-normal h-auto py-2">
