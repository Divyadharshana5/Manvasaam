...
export default function FleetExport() {
  ...
  const handleDeselectAllFields = (category?: string) => {
    ...
    setExportSettings((prev) => ({
      ...prev,
      includeFields: prev.includeFields.filter(
        (f) => !fieldsToDeselect.includes(f)
      ),
    }));
  };
  ...
  const handleExport = () => {
    ...
    const fileName = `${exportSettings.reportName}_${
    ...
    element.setAttribute(
      ...
      "data:text/plain;charset=utf-8," +
        encodeURIComponent("Mock fleet data export")
    );
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Filter vehicles and organize data
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setExportSettings({ ...exportSettings, filterBy: value })
                  }
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setExportSettings({ ...exportSettings, groupBy: value })
                  }
                >
                  <SelectTrigger>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    {fields.map((field) => (
                      ...
                      >
                        <Checkbox
                          id={field.id}
                          checked={exportSettings.includeFields.includes(
                            field.id
                          )}
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Customize your report appearance and delivery
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {
                    formatOptions.find((f) => f.value === exportSettings.format)
                      ?.label
                  }
                </p>
              </div>
                ...
                <p className="text-sm text-muted-foreground">
                  {
                    dateRangeOptions.find(
                      (d) => d.value === exportSettings.dateRange
                    )?.label
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {
                    filterOptions.find(
                      (f) => f.value === exportSettings.filterBy
                    )?.label
                  }
                </p>
              </div>
