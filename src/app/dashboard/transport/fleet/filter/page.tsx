            ...
            <div className="flex flex-col gap-4 p-4 md:gap-6 md:p-6 max-w-4xl mx-auto">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Filter by location and assigned driver</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Filter by fuel, battery, and temperature</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            <div>
                                <div className="flex items-center gap-2 mb-2">
                                    <Fuel className="h-4 w-4" />
                                    <Label>Fuel Level: {filters.fuelRange[0]}% - {filters.fuelRange[1]}%</Label>
                                </div>
                                <Slider
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <Label>Battery Level: {filters.batteryRange[0]}% - {filters.batteryRange[1]}%</Label>
                                </div>
                                <Slider
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <Label>Temperature: {filters.temperatureRange[0]}°C - {filters.temperatureRange[1]}°C</Label>
                                </div>
                                <Slider
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <Label>Mileage: {filters.mileageRange[0]} - {filters.mileageRange[1]} km/l</Label>
                                </div>
                                <Slider
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Filter by maintenance and service status</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                                        ...
                                        <Checkbox
                                            ...
                                            onCheckedChange={(checked) => {
                                                if (checked) {
                                                    setFilters({
                                                        ...filters,
                                                        serviceStatus: [...filters.serviceStatus, option.id]
                                                    });
                                                } else {
                                                    setFilters({
                                                        ...filters,
                                                        serviceStatus: filters.serviceStatus.filter(s => s !== option.id)
                                                    });
                                                }
                                            }}
                                        />
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Review your current filter settings</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="flex flex-wrap gap-2">
                            ...
                            {filters.driver !== "all" && (
                                <Badge variant="secondary">
                                    Driver: {driverOptions.find(d => d.value === filters.driver)?.label}
                                </Badge>
                            )}
                            {filters.search && (
                                <Badge variant="secondary">
