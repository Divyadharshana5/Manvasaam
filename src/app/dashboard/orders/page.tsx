    ...
    <AppLayout>
      <div className="space-y-4 md:space-y-6 py-4 md:py-6 page-transition">
        <div className="flex flex-col gap-1.5 animate-fade-in-up">
          ...
          <p className="text-muted-foreground text-sm animate-slide-in-left stagger-1">
            {t.orders.description}
          </p>
        </div>
        <Card className="shadow-sm border card-glow animate-fade-in-up stagger-2">
                            ...
                            <TableCell className="text-center py-3">
                              {(order.status === "Shipped" ||
                                ...
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="h-8 text-xs btn-hover transition-all duration-300 hover:scale-105"
                      ...
                      {(order.status === "Shipped" ||
                        ...
                        <CardFooter className="pt-0 pb-3 px-4">
                          <Button
                            ...
                            variant="outline"
                            size="sm"
                            className="w-full h-8 text-xs btn-hover transition-all duration-300 hover:scale-105"
                            onClick={(e) => e.stopPropagation()}
                          >
          ...
          {shippingInfo ? (
            <div className="space-y-4 pt-1">
              ...
              <div className="space-y-3 pt-2">
                <h4 className="font-semibold text-sm md:text-base animate-fade-in-up stagger-4">
                  {t.orders.shipmentHistory}
                </h4>
                <div className="relative pl-7 md:pl-8">
                  <div className="absolute left-[13px] md:left-[15px] top-2 h-[calc(100%-16px)] w-0.5 bg-border animate-fade-in stagger-5"></div>
                  {shippingInfo.path.map((stop, index) => (
                    <div
                      key={index}
                      className={cn(
                        "relative flex items-start gap-3 mb-4 last:mb-0 animate-slide-in-left hover:bg-muted/20 rounded-lg p-2 -ml-2 transition-all duration-300",
                        `stagger-${index + 6}`
                      )}
                    >
                      <div className="z-10 flex h-7 w-7 md:h-8 md:w-8 items-center justify-center rounded-full bg-primary text-primary-foreground shrink-0 hover:scale-110 transition-transform duration-300">
