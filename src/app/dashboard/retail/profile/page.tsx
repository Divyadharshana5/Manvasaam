...
export default function RetailProfilePage() {
  ...
  const [shopProfile, setShopProfile] = useState<RetailShopProfile | null>(
    null
  );
  ...
  async function onSubmit(values: z.infer<typeof profileFormSchema>) {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          responseData.message || `Failed to update shop profile`
        );
      }
        ...
        <div className="bg-white rounded-lg border p-6 animate-fade-in-up stagger-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-base">
                {profileData.shopName || "Not provided"}
              </p>
            </div>
            <div className="space-y-1">
              <label className="text-sm font-medium text-gray-600">
              ...
              <p className="text-base">
                {profileData.shopType || "Retail Store"}
              </p>
            </div>
            <div className="space-y-1">
              <label className="text-sm font-medium text-gray-600">
              ...
              <p className="text-base">
                {profileData.ownerName || "Not provided"}
              </p>
            </div>
            <div className="space-y-1">
              <label className="text-sm font-medium text-gray-600">
            ...
            <div className="space-y-1">
              ...
              <p className="text-base">
                {profileData.businessHours || "Not specified"}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border p-6 animate-fade-in-up stagger-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-base">
                {profileData.deliveryRadius || "Not specified"}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-green-50 rounded-lg border border-green-200 p-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-green-800">
              Status:{" "}
              {profileData.verified ? "Verified Shop" : "Pending Verification"}
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between animate-fade-in-up">
          ...
          <div>
            <Button
              type="button"
              onClick={() => {
                console.log("[RetailProfile] Open modal");
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    placeholder="Grocery & Fresh Produce"
                                    {...field}
                                  />
                                </FormControl>
                                <FormMessage />
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem className="md:col-span-2">
                                ...
                                <FormControl>
                                  <Textarea
                                    placeholder="123, Market Street, Commercial Complex"
                                    {...field}
                                  />
                                </FormControl>
                                <FormMessage />
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input
                                  placeholder="Fresh Vegetables, Organic Products, Daily Essentials"
                                  {...field}
                                />
                              </FormControl>
                              <FormMessage />
