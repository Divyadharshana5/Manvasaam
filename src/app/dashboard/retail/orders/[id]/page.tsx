...
Report generated by Retail Management System
  ...
  return (
    <div className="flex flex-1 flex-col gap-6 p-4 md:gap-8 md:p-8 page-transition">
      {/* Header */}
          ...
          <Card className="animate-fade-in-up stagger-2">
            ...
            <CardContent>
              <div className="space-y-4">
                {order.items.map((item, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg animate-fade-in-up list-item" style={{ animationDelay: `${index * 0.1}s` }}>
