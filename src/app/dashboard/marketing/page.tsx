        ...
        <div className="grid gap-6 lg:grid-cols-2">
           <Card className="shadow-lg border-2 border-primary/10">
            <CardHeader>
              ...
              <CardDescription>
                Describe your product or offer, and let AI create a captivating post with an image for you.
              </CardDescription>
            </CardHeader>
            ...
            <CardFooter>
              <Button onClick={handleGeneratePost} disabled={isLoading || !prompt}>
                {isLoading ? (
             ...
             <Card className="shadow-lg border-2 border-primary/10">
                ...
                <CardContent className="space-y-4">
                    <div className="relative aspect-video w-full overflow-hidden rounded-lg border">
                        <Image src={generatedContent.image} alt="Generated marketing image" layout="fill" objectFit="cover" />
                    </div>
                ...
                <Card className="shadow-lg border-2 border-primary/10">
                    ...
                    <CardContent>
                        <ChartContainer config={lineChartConfig} className="h-64">
                            <RechartsLineChart accessibilityLayer data={lineChartData} margin={{ left: 12, right: 12 }}>
                                <CartesianGrid vertical={false} />
