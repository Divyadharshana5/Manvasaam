    ...
    <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle>
              {t?.voiceAssistant?.voiceControlTitle ?? "Voice Control"}
            </CardTitle>
            <CardDescription>
              {t?.voiceAssistant?.voiceControlDesc ??
          ...
          <CardContent className="text-center space-y-6">
            ...
            <div>
              <p className="text-lg font-medium">
                {t?.voiceAssistant?.voiceNavigation ?? "Voice Navigation"}
              </p>
              <p className="text-sm text-muted-foreground">
                {t?.voiceAssistant?.voiceNavigationDesc ??
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              {t?.voiceAssistant?.languageTitle ?? "Language Settings"}
            </CardTitle>
            <CardDescription>
              {t?.voiceAssistant?.languageDesc ??
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {t?.voiceAssistant?.availableCommands ?? "Available Commands"}
          </CardTitle>
          <CardDescription>
            {t?.voiceAssistant?.availableCommandsDesc ??
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {t?.voiceAssistant?.helpDesc ??
              "Get the most out of voice assistant"}
          </CardDescription>
        </CardHeader>
        <CardContent>
